...
@section('content')
    <div id="wrapper">
            ...
            <div class="navbar-default sidebar" role="navigation">
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
                        ...
                        <li><a class="active" href="{{ route('dashboard.getManageRecords', 'categories') }}">Manage Category Records<span class="badge pull-right">Edit</span></a></li>
        ...
        <div id="page-wrapper">
            ...
            {!! Form::open(array('route' => ['dashboard.postEditRecord', 'categories', $id], 'data-form' => 'edit-category-form')) !!}
                <div class="enclosure">
                    <div class="row">
                        <div class="col-sm-12">
