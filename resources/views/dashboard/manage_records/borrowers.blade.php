...
@section('content')
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Manage Borrowers</h1>
                </div>
            </div>
            ...
            <div class="text-right gap-bottom">
                <a href="{{ route('dashboard.getAddRecord', 'borrowers') }}" class="btn btn-primary">Add Borrower</a>
            </div>
            <table id="borrowers-table" class="table table-bordered table-striped">
                <thead>
                    <tr>
                        <th>Username</th>
                        <th>Name</th>
