    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            ...
            <div class="text-right gap-bottom">
                <a href="{{ route('dashboard.getAddRecord', 'publishers') }}" class="btn btn-primary">Add Publisher</a>
            </div>
            <table id="publishers-table" class="table table-bordered table-striped">
                <thead>
                    <tr>
                        <th>Name</th>
                        <th width="20%"></th>
                        ...
                        <tr>
                            ...
                            <td class="text-center">
                                @if(session()->has('username'))
                                    <a href="{{ route('dashboard.getEditRecord', ['publishers', $publisher->Publisher_ID]) }}" class="btn btn-success btn-xs">Edit</a>
                                    <a href="{{ route('dashboard.getDeleteRecord', ['publishers', $publisher->Publisher_ID]) }}" class="btn btn-danger btn-xs">Delete</a>
                                @endif
                            </td>
                        </tr>
                    @endforeach
