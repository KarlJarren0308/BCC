...
@section('content')
    <div id="wrapper">
            ...
            <div class="navbar-default sidebar" role="navigation">
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
                        ...
                        <li><a class="active" href="{{ route('dashboard.getManageRecords', 'borrowers') }}">Manage Borrowers<span class="badge pull-right">Add</span></a></li>
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Add Borrower</h1>
                </div>
            </div>
            ...
            {!! Form::open(array('route' => ['dashboard.postAddRecord', 'borrowers'], 'data-form' => 'add-borrower-form')) !!}
                <div class="enclosure">
                    <div class="row">
                        <div class="col-sm-6">
                            <div class="form-group">
                                {!! Form::label('borrowerID', 'Borrower\'s ID: *') !!}
                                {!! Form::text('borrowerID', null, ['class' => 'form-control', 'placeholder' => '', 'required' => 'required', 'autofocus' => 'autofocus']) !!}
                            </div>
                        </div>
                        <div class="col-sm-6">
                            <div class="form-group">
