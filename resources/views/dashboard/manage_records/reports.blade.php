        ...
        <div id="page-wrapper">
            ...
            <div class="row">
                <div class="col-sm-4">
                    <div class="panel panel-red">
                        <div class="panel-heading">
                            <strong class="panel-title">List of Books Report</strong>
                        </div>
                        <div class="panel-body">
                            {!! Form::open(['route' => ['dashboard.postGenerateReport', 'list_of_books']]) !!}
                ...
                <div class="col-sm-4">
                    <div class="panel panel-red">
                        <div class="panel-heading">
                            <strong class="panel-title">List of Borrowed Books Report</strong>
                        </div>
                        <div class="panel-body">
                            {!! Form::open(['route' => ['dashboard.postGenerateReport', 'list_of_borrowed_books']]) !!}
                                <div class="form-group">
                                    {!! Form::label('from', 'From: *') !!}
                                    {!! Form::date('from', null, ['class' => 'form-control', 'placeholder' => '', 'required' => 'required']) !!}
                                </div>
                ...
                <div class="col-sm-4">
                    <div class="panel panel-red">
                        <div class="panel-heading">
                            <strong class="panel-title">List of Unreturned Books Report</strong>
                        </div>
                        <div class="panel-body">
...
@section('post_ref')
<script src="/js/dashboard/manage_records/reports.js"></script>
@stop