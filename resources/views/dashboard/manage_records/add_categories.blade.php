    ...
    <div id="wrapper">
            ...
            <div class="navbar-default sidebar" role="navigation">
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
                        ...
                        <li><a class="active" href="{{ route('dashboard.getManageRecords', 'categories') }}">Manage Category Records<span class="badge pull-right">Add</span></a></li>
        ...
        <div id="page-wrapper">
            ...
            <div class="text-left" style="margin-bottom: 25px;">
                <a href="{{ route('dashboard.getManageRecords', 'categories') }}" class="btn btn-danger btn-xs"><span class="fa fa-arrow-left gap-right"></span>Go Back</a>
            </div>
            {!! Form::open(array('route' => ['dashboard.postAddRecord', 'categories'], 'data-form' => 'add-category-form')) !!}
                <div class="enclosure">
                    <div class="row">
                        <div class="col-sm-12">
                            <div class="form-group">
                                {!! Form::label('categoryName', 'Category Name:') !!}
                                {!! Form::text('categoryName', null, ['class' => 'form-control', 'placeholder' => '', 'required' => 'required', 'autofocus' => 'autofocus']) !!}
                            </div>
                        </div>
                    </div>
...
@section('post_ref')
    <script src="/js/dashboard/manage_records/categories.js"></script>
@stop