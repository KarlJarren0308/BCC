...
@section('content')
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Edit Librarian</h1>
                </div>
            </div>
            ...
            {!! Form::open(array('route' => ['dashboard.postEditRecord', 'librarians', $librarian->Librarian_ID])) !!}
                <div class="enclosure">
                    <div class="row">
                        <div class="col-sm-6">
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-4">
                            <div class="form-group">
                                ...
                                {!! Form::text('middleName', $librarian->Middle_Name, ['class' => 'form-control', 'placeholder' => '']) !!}
                            </div>
                        </div>
                        <div class="col-sm-4">
                            <div class="form-group">
                                {!! Form::label('lastName', 'Last Name: *') !!}
                                {!! Form::text('lastName', $librarian->Last_Name, ['class' => 'form-control', 'placeholder' => '', 'required' => 'required']) !!}
                            </div>
                        </div>
                    </div>
                    <div class="row">
