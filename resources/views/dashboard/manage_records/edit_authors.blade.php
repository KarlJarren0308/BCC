            ...
            <div class="navbar-default sidebar" role="navigation">
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
                        ...
                        <li><a class="active" href="{{ route('dashboard.getManageRecords', 'authors') }}">Manage Author Records<span class="badge pull-right">Add</span></a></li>
                    ...
                    <div class="row">
                        <div class="col-sm-4">
                            <div class="form-group">
                                ...
                                {!! Form::text('firstName', $author->First_Name, ['class' => 'form-control', 'placeholder' => '', 'required' => 'required', 'autofocus' => 'autofocus']) !!}
                            </div>
                        </div>
                        <div class="col-sm-4">
                            <div class="form-group">
                                {!! Form::label('middleName', 'Middle Name:') !!}
                                {!! Form::text('middleName', $author->Middle_Name, ['class' => 'form-control', 'placeholder' => '']) !!}
                            </div>
                        </div>
                        <div class="col-sm-4">
                            <div class="form-group">
                                {!! Form::label('lastName', 'Last Name: *') !!}
                                {!! Form::text('lastName', $author->Last_Name, ['class' => 'form-control', 'placeholder' => '', 'required' => 'required']) !!}
                            </div>
                        </div>
                    </div>
