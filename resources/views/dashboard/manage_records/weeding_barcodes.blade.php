...
@section('content')
    <div id="wrapper">
            ...
            <div class="navbar-default sidebar" role="navigation">
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
                        ...
                        <li><a class="active" href="{{ route('dashboard.getManageRecords', 'weeding') }}">Weeding Books<span class="badge pull-right">A. N.</span></a></li>
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Weeded Books - Manage Accession Numbers</h1>
                </div>
            </div>
            <div class="row">
                <div class="col-sm-6">
                    <div class="text-left" style="margin-bottom: 25px;">
                        <a href="{{ route('dashboard.getManageRecords', 'weeding') }}" class="btn btn-danger btn-xs"><span class="fa fa-arrow-left gap-right"></span>Go Back</a>
                    </div>
