    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            ...
            <div class="text-right gap-bottom">
                <a href="{{ route('dashboard.getAddRecord', 'categories') }}" class="btn btn-primary">Add Category</a>
            </div>
                        ...
                        <tr>
                            ...
                            <td class="text-center">
                                @if(session()->has('username'))
                                    <a href="{{ route('dashboard.getEditRecord', ['categories', $category->Category_ID]) }}" class="btn btn-success btn-xs">Edit</a>
                                    <a href="{{ route('dashboard.getDeleteRecord', ['categories', $category->Category_ID]) }}" class="btn btn-danger btn-xs">Delete</a>
                                @endif
                            </td>
                        </tr>
                    @endforeach
