            ...
            <div class="navbar-default sidebar" role="navigation">
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
                        ...
                        <li><a class="active" href="{{ route('dashboard.getManageRecords', 'holidays') }}">Manage Holidays<span class="badge pull-right">Edit</span></a></li>
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <div class="form-group">
                                ...
                                {!! Form::text('holidayDescription', $holiday->Description, ['class' => 'form-control', 'placeholder' => '', 'required' => 'required', 'autofocus' => 'autofocus']) !!}
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-sm-6">
                            <div class="form-group">
                                ...
                                {!! Form::date('dateStamp', $holiday->Date_Stamp, ['class' => 'form-control', 'placeholder' => '', 'required' => 'required']) !!}
                            </div>
                        </div>
                        <div class="col-sm-6">
                            <div class="form-group">
                                ...
                                <select name="type" id="type" class="form-control">
                                    ...
                                    <option value="Class Suspension"{{ ($holiday->Type == 'Class Suspension' ? ' selected' : '') }}>Class Suspension</option>
                                </select>
                            </div>
                        </div>
                    </div>
