                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-3">
                            <div class="form-group">
                                ...
                                <select name="language" id="language" class="form-control" required>
                                    ...
                                    <option value="English" selected>English Language</option>
                        ...
                        <div class="col-sm-3">
                            <div class="form-group">
                                ...
                                {!! Form::date('dateAcquired', date('Y-m-d'), ['class' => 'form-control', 'placeholder' => '', 'required' => 'required']) !!}
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        ...
                        <div class="col-sm-4">
                            <div class="form-group">
                                ...
                                {!! Form::text('edition', null, ['class' => 'form-control', 'required' => 'required', 'placeholder' => '']) !!}
                            </div>
                        </div>
                        <div class="col-sm-4">
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    <label class="input-group-addon">
                                        <input type="radio" name="acquisitionMethod" value="Donated"> Donated
                                    </label>
                                    <label class="input-group-addon">
                                        <input type="radio" name="acquisitionMethod" value="Purchased"> Purchased
                                    </label>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="row">
                        <div class="col-sm-4">
                            <div class="form-group">
                                ...
                                {!! Form::text('isbn', null, ['class' => 'form-control', 'placeholder' => '']) !!}
                            </div>
                        </div>
                        <div class="col-sm-4">
                            <div class="form-group">
